IF NOT EXISTS (SELECT * FROM master.dbo.sysdatabases WHERE name = 'productsdb1') 
CREATE DATABASE productsdb1;
GO
...
BEGIN
 ...
 SELECT CUSTOMERS.CustomerName,MANAGERS.ManagerName,SUM(ORDERS.AMOUNT) as TotalAmount
 FROM CUSTOMERS
 INNER JOIN MANAGERS ON CUSTOMERS.MANAGER_ID=MANAGERS.Id
 INNER JOIN ORDERS ON CUSTOMERS.Id=ORDERS.CUSTOMER_ID
 WHERE OrderDate >= @Date
 GROUP BY ORDERS.CUSTOMER_ID,CUSTOMERS.CustomerName,MANAGERS.ManagerName
 HAVING SUM(ORDERS.AMOUNT)>@Amount
